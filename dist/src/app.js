                        ...
                        switch ((_context.prev = _context.next)) {
                            ...
                            case 32:
                                ...
                                if (
                                    !(
                                        !result.length ||
                                        result[result.length - 1].id === minSeen
                                    )
                                ) {
                                    _context.next = 36;
                                    break;
                            ...
                            case 47:
                                ...
                                if (!NO_GROUPING)
                                    recordData = groupEntries(recordData);
                                ...
                                if (CHECK) {
                                    Object.keys(runningBalance).forEach(
                                        function(asset) {
                                            if (!runningBalance[asset][0])
                                                return;
                                            runningBalance[asset].sort(function(
                                                a,
                                                b
                                            ) {
                                                return (
                                            ...
                                            runningBalance[asset][0].push(
                                                runningBalance[asset][0][1]
                                            );

                                            for (
                                                var i = 1;
                                                i <
                                                runningBalance[asset].length;
                                                i++
                                            ) {
                                                runningBalance[asset][i].push(
                                                    runningBalance[asset][
                                                        i
                                                    ][1] +
                                                        runningBalance[asset][
                                                            i - 1
                                    ...
                                    console.log("");
                                    assetsToCheck.forEach(function(
                                        assetToCheck
                                    ) {
                                        console.log(
...
var operations = require("x4tradejs").ChainTypes.operations;
